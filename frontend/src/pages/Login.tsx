    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Sistema de Gestión de Insumos — DuocUC</p>
        </div>

        {/* Card oscura integrada con el fondo */}
          ...
          {!is2FA ? (
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                {error && (
                  <p className="text-rose-400 text-xs bg-rose-950 border border-rose-800 px-3 py-2 rounded-lg font-semibold">
                    {error}
                  </p>
                )}
            ...
            <>
              ...
              <form onSubmit={handleTotp} className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-4 rounded-lg border border-slate-700 bg-slate-900 text-white
        ...
        <p className="text-center text-slate-600 text-xs mt-6">Escuela de Salud — DuocUC</p>
      </div>
    </div>
  )
}
